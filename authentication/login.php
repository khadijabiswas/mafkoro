...
<div class="alert-content">
<span class="alert-title"> <?php echo $_SESSION['login_unsuccess'] ?>
</span>
</div>
<?php } unset($_SESSION['login_unsuccess']);?>
