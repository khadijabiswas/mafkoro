...
<form action= "manage.php" method= "POST">
            ...
            <div class="auth-credentials m-b-xxl">
                ...
                <input name="username" type="text" class="form-control m-b-md <?php  if(isset($_SESSION["name_error"])) { echo 'is-invalid'; }else { echo ''; } ?>" 
                ...
                <input name="email" type="email" class="form-control m-b-md  <?php  if(isset($_SESSION["email_error"])) { echo 'is-invalid'; }else { echo ''; } ?>" 
