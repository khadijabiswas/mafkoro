...
<body>
    <div class="app align-content-stretch d-flex flex-wrap">
            ...
            <div class="logo">
                ...
                <div class="sidebar-user-switcher user-activity-online">
                    <a href="#">
                        ...
                        <img src="../../public/uplods/default/<?= $user['image']?>">
                        <?php else : ?>
                        <img src="../../public/uplods/profile/<?= $user['image']?>">
                        <?php  endif; ?>
        ...
        <div class="app-container">
         ...
         <a class="nav-link btn btn-danger btn-sm text-white" href="../../logout/logout.php">
            <i class="fa-solid fa-right-from-bracket"></i>logout</a>
              ...
              <!-- <div class="app-content"><div class="row">
                            <div class="col">
